...
load_dat_lso <- function(
  ...
  new_names <- c(
    ...
    "emancipative_norms" = "gender_norms",
    "good_parenting" = "parenting",
    "safe_school" = "safe_school",
  ...
  var.labels <- c(
    ...
    safe_school = "Safe schools",
    parenting = "Parental monitoring",
    gender_norms = "Positive gender norms",
